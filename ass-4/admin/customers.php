...
class Customer {
    private $dataFile = 'data/customers.json';
    ...
    {
        $customers = $this->loadCustomers();
        $updatedCustomers = array_filter($customers, function ($customer) use ($id) {
...
class CustomerManager {
    ...
    public function addCustomer(Customer $customer) {
        ...
        $customers[] = $customer;
        file_put_contents($this->filePath, json_encode($customers, JSON_PRETTY_PRINT));
    }
    public function getAllCustomers() {
        ...
        return array_map(function ($item) {
            return new Customer($item['id'], $item['name'], $item['email']);
        }, $data);
    }
}
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $customerManager = new CustomerManager('data/customers.json');
